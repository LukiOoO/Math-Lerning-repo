...
from home.serializers import PictrueSerializer
from home.models import Pictures
import pytest
from rest_framework.test import APIRequestFactory
from home.views import BasePictureViewSet
...
def test_pictures_model():
    ...
    assert picture.image_field.name.startswith("static/images/image_")
